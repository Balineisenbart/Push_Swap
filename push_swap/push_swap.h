...
int					parse_input(int argc, char **argv, t_node **stack,
						t_node **tail);
int					two_args(char **argv, t_node **stack, t_node **tail);
int					more_args(int argc, char **argv, t_node **stack,
						t_node **tail);
...
void				complex_sorting(t_node **head_a, t_node **tail_a,
						t_node **head_b, t_node **tail_b);
void				push_chunk(t_node **head_a, t_node **tail_a,
						t_node **head_b, t_node **tail_b);
bool				contains_chunk(t_node *head_a);
int					determine_chunk_number(int length);
void				define_chunk(t_node **head, int current_chunk,
						int previous_chunk);
